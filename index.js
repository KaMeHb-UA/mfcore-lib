...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of mfcore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of mfcore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._mfcore);
global._mfcore = bitcore.version;
