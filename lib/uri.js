 ...
 * ```javascript
 *
 * var uri = new URI('mfcoin:MtLuhPhaexZjxYUTJAp9gGMU1M7bMxhLo8?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('mfcoin:MtLuhPhaexZjxYUTJAp9gGMU1M7bMxhLo8');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'mfcoin:') {
    throw new TypeError('Invalid mfcoin URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid mfcoin address');
  }
